...
void const_iterators() {
	...
	std::vector<const int>                 def(src.begin(), src.end());
	std::vector<const int>::const_iterator cit(def.begin());
...
//	*cit = 6; // DOES NOT COMPILE
	...
	--cit;
	std::vector<const int>::const_iterator cit2(def.begin());
	...
	std::vector<int>::const_iterator cit_src(src.begin());
...
void reverse_iterators() {
	...
	std::vector<const int>                         def(src.begin(), src.end());
	std::vector<const int>::const_reverse_iterator rcit(def.rbegin());
...
//	*rcit = 6; // DOES NOT COMPILE
	...
	--rcit;
	std::vector<const int>::const_reverse_iterator rcit2(def.rbegin());
	...
	std::vector<int>::const_reverse_iterator rcit_src(src.rbegin());
...
void const_iter_with_iter() {
	...
	std::vector<int>::const_iterator cit(def.begin());
	...
	std::vector<int>::reverse_iterator       rit(def.begin());
	std::vector<int>::const_reverse_iterator rcit(def.begin());
