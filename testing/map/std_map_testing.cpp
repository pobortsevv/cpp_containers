...
void print_map(std::map<int, Test> & map) {
	typename std::map<int, Test>::iterator it(map.begin());
...
void constructor_first_last() {
	...
	std::map<int, Test> def(src.begin(), src.end());
...
void erase_position() {
	...
	std::map<int, Test>::iterator it(def.begin());
...
void erase_firts_last() {
	...
	std::map<int, Test>           def(src.begin(), src.end());
	std::map<int, Test>::iterator first(def.begin());
	std::map<int, Test>::iterator last(def.end());
...
void swap() {
	...
	std::map<int, Test>           def(src.begin(), src.end());
	std::map<int, Test>           def2(src2.begin(), src2.end());
...
void equal_range() {
	...
	std::pair<std::map<int, Test>::iterator, std::map<int, Test>::iterator>
...
void reverse_iterator() {
	...
	std::map<int, Test>                   def(src.begin(), src.end());
	std::map<int, Test>::reverse_iterator rit(def.rbegin());
